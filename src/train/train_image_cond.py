...
def main():
    ...
    # Set all parameters to not trainable
    for param in model.parameters():
        param.requires_grad = False

    # Set proj_out parameters to trainable
    ...
    trainable_to_total_ratio = trainable_params / total_params
    
    # Print all named parameters and whether they are trainable
    for name, param in model.named_parameters():
    ...
    print(f"Trainable to total ratio: {trainable_to_total_ratio:.4f}")
